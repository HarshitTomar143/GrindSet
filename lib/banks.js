...
// CTET's papers and the UP TGT/PGT subject banks (Hindi, English, General
// Studies) live side by side here while staying completely separate on screen.
// ---------------------------------------------------------------------------
...
/**
 * General Studies follows the board's printed GS syllabus ("UP TGT-PGT GS
 * Syllabus Main heading.pdf" and "…Details.pdf" in the repo root): ten numbered
 * units, each with its own bullets. A topic here is named for the syllabus
 * bullet it answers, not for the workbook it came from — several booklets cover
 * more than one unit, so a topic may be one workbook narrowed to the chapters
 * (`part`) or sections (`subject_name`) that belong to its unit. A workbook
 * listed nowhere below still shows up under "Other topics", so a new one is
 * never silently lost.
 *
 * Two banks are declared but carry nothing usable yet and so never reach the
 * page: the environment booklet's extraction stored no question text at all,
 * and the population booklet's source PDF prints no answer key.
 */
const GS_TOPICS = [
  // Unit 1 — समसामयिकी. No current-affairs bank exists yet. The UP general
  // knowledge bank sits here because the unit's third bullet, "उत्तर प्रदेश से
  // जुड़ी राज्यस्तरीय घटनाएँ (योजनाएँ, पुरस्कार, नियुक्तियाँ)", is the only
  // place the printed syllabus asks for state-level material.
  {
    id: "up-samanya-gyan",
    name: "UP General Knowledge",
    nameHi: "उत्तर प्रदेश सामान्य ज्ञान",
    files: ["UP_Samanya_Gyan_Questions (1).xlsx"],
  },

  // Unit 2 — भारतीय इतिहास एवं स्वतंत्रता आन्दोलन. One topic per period, which
  // is exactly the three bullets the syllabus prints, and exactly the three
  // booklets that were extracted.
  {
    id: "ancient-history",
    name: "Ancient India",
    nameHi: "प्राचीन भारत",
    files: ["Ancient_History_Questions.xlsx"],
  },
  {
    id: "medieval-history",
    name: "Medieval India",
    nameHi: "मध्यकालीन भारत",
    files: ["Medieval_History_Questions.xlsx"],
  },
  {
    id: "modern-history",
    name: "Modern India & National Movement",
    nameHi: "आधुनिक भारत एवं राष्ट्रीय आंदोलन",
    files: ["Adhunik_Bharat_Question_Bank.xlsx"],
  },

  // Unit 3 — भारतीय संविधान एवं राजव्यवस्था. The booklet is split into two
  // printing runs rather than into topics, so its four syllabus bullets cannot
  // be separated and the unit stays one topic.
  {
    id: "samvidhan",
    name: "Constitution & Polity",
    nameHi: "भारतीय संविधान एवं राज्यव्यवस्था",
    files: ["Bhartiya_Samvidhan_Questions.xlsx"],
  },

  // Unit 4 — भारतीय अर्थव्यवस्था. The economy workbook labels its rows by the
  // exam each question came from, not by topic, so it stays whole; agriculture,
  // commerce and trade came as a booklet of its own.
  {
    id: "arthvyavastha",
    name: "Indian Economy",
    nameHi: "भारतीय अर्थव्यवस्था",
    files: ["Indian_Economy_Questions.xlsx"],
  },
  {
    id: "krishi-vanijya",
    name: "Agriculture, Commerce & Trade",
    nameHi: "कृषि, वाणिज्य एवं व्यापार",
    files: ["Krishi_Vanijya_Vyapar_Questions.xlsx"],
  },

  // Unit 5 — भारत का सामान्य भूगोल एवं जनसंख्या. The geography booklet's
  // chapters (`part`) are sorted into the unit's three bullets — भौतिक भूगोल,
  // आर्थिक भूगोल, जनसंख्या. Its longest chapter is printed as one loose
  // "General Knowledge" run, so those rows are placed by the finer heading each
  // one carries (`subject_name`) instead; national parks are the exception and
  // go to unit 7, which names them.
  {
    id: "bhautik-bhugol",
    name: "Physical Geography",
    nameHi: "भौतिक भूगोल",
    files: ["Bharat_ka_Bhugol_Questions.xlsx"],
    parts: [
    ...
    subjects: ["प्रमुख झीलें", "जल प्रपात"],
  },
  {
    id: "arthik-bhugol",
  ...
  {
    id: "jansankhya",
    name: "Population & Tribes",
    nameHi: "जनसंख्या एवं जनजातियाँ",
    files: [
      "Bharat_ka_Bhugol_Questions.xlsx",
      "Bhartiya_Jansankhya_Questions.xlsx",
    ],
    parts: ["Tribes", "Bhartiya Jansankhya"],
  },
  {
    id: "anusandhan-sansthan",
    name: "Research Institutes & Plants",
    nameHi: "प्रमुख अनुसंधान संस्थान",
    files: ["Bharat_ka_Bhugol_Questions.xlsx"],
    parts: ["Major Research Institutes"],
  },
  {
    id: "bhugol-vividh",
    name: "Geography Miscellany",
    nameHi: "भूगोल — विविध",
    files: ["Bharat_ka_Bhugol_Questions.xlsx"],
    subjects: ["General Knowledge"],
  },

  // Unit 6 — सामान्य विज्ञान एवं प्रौद्योगिकी. The science booklet is printed
  // in four parts that land on the unit's four bullets exactly. Its part names
  // carry the Devanagari matra reordering the source PDF's text layer has
  // throughout, so they are matched here character for character.
  {
    id: "bhautik-vigyan",
    name: "Physics",
    nameHi: "भौतिक विज्ञान",
    files: ["Samanya_Vighyan_Questions.xlsx"],
    parts: ["भौविक विज्ञान (PHYSICS)"],
  },
  {
    id: "rasayan-vigyan",
    name: "Chemistry",
  ...
  },
  {
    ...
    nameHi: "जीव विज्ञान",
    files: ["Samanya_Vighyan_Questions.xlsx"],
    parts: ["िीि विज्ञान (Biology)"],
  },
  {
    id: "praudyogiki",
    name: "Space & Defence Technology",
    nameHi: "अंतरिक्ष एवं रक्षा प्रौद्योगिकी",
    files: ["Samanya_Vighyan_Questions.xlsx"],
    parts: ["अं िररक्ष एिं रक्षा प्रौद्योविकी (Space & Defence Technology)"],
  },

  // Unit 7 — पर्यावरण एवं पारिस्थितिकी. The environment booklet is extracted
  // but unusable, so until it is re-parsed the unit is served by the national
  // parks chapter of the geography booklet — a bullet the syllabus prints here
  // ("वन्यजीव अभयारण्य एवं राष्ट्रीय उद्यान") rather than under geography.
  {
    id: "rashtriya-udyan",
    name: "Wildlife & National Parks",
    nameHi: "वन्यजीव अभयारण्य एवं राष्ट्रीय उद्यान",
    files: ["Bharat_ka_Bhugol_Questions.xlsx"],
    subjects: ["राष्ट्रीय उद्यान"],
  },
  {
    id: "paryavaran",
    name: "Environment & Ecology",
    nameHi: "पर्यावरण एवं पारिस्थितिकी",
    files: ["Environment_Ecology_Questions.xlsx"],
  },

  // Units 8 and 9 come out of one workbook: its भाग 2 is the computer and
  // internet terminology the syllabus lists as unit 8, and its भाग 1 is the
  // ICT applications listed as unit 9.
  {
    id: "computer-shabdavali",
    name: "Computer & Internet Terminology",
    nameHi: "कम्प्यूटर एवं इंटरनेट शब्दावली",
    files: ["ICT_Questions_Extracted.xlsx"],
    parts: ["भाग 2: सामान्य कंप्यूटर शब्दावली एवं UGC NET PYQs"],
  },
  {
    id: "ict",
    name: "ICT Applications",
    nameHi: "ICT के अनुप्रयोग",
    files: ["ICT_Questions_Extracted.xlsx"],
    parts: ["भाग 1: ICT के अनुप्रयोग"],
  },

  // Unit 10 — शैक्षिक प्रौद्योगिकी में विकास.
  {
    id: "shaikshik-praudyogiki",
    name: "Educational Technology",
    nameHi: "शैक्षिक प्रौद्योगिकी में विकास",
    files: ["Educational_Technology_Questions.xlsx"],
  },
];

/**
 * The ten GS syllabus units, in the order and under the names the syllabus
 * prints them. The section page numbers the units it shows, so while every unit
 * has questions the numbers on screen are the syllabus's own.
 */
const GS_UNITS = [
  {
    id: "samsamayiki",
    ...
    nameHi: "समसामयिकी",
    topics: ["up-samanya-gyan"],
  },
  {
    id: "itihas",
    name: "Indian History & Freedom Movement",
    nameHi: "भारतीय इतिहास एवं स्वतंत्रता आन्दोलन",
    topics: ["ancient-history", "medieval-history", "modern-history"],
  },
  {
    id: "rajvyavastha",
    name: "Constitution & Polity",
    nameHi: "भारतीय संविधान एवं राजव्यवस्था",
    topics: ["samvidhan"],
  },
  {
    id: "arthvyavastha",
    name: "Indian Economy",
    nameHi: "भारतीय अर्थव्यवस्था",
    topics: ["arthvyavastha", "krishi-vanijya"],
  },
  {
    id: "bhugol",
    name: "Geography of India & Population",
    nameHi: "भारत का सामान्य भूगोल एवं जनसंख्या",
    topics: [
      "bhautik-bhugol",
      "arthik-bhugol",
      "jansankhya",
  ...
  {
    id: "vigyan-praudyogiki",
    name: "General Science & Technology",
    nameHi: "सामान्य विज्ञान एवं प्रौद्योगिकी",
    topics: ["bhautik-vigyan", "rasayan-vigyan", "jeev-vigyan", "praudyogiki"],
  },
  {
    id: "paryavaran",
    name: "Environment & Ecology",
    nameHi: "पर्यावरण एवं पारिस्थितिकी",
    topics: ["rashtriya-udyan", "paryavaran"],
  },
  {
    id: "computer",
    name: "Computer & Internet Terminology",
    nameHi: "कम्प्यूटर एवं इंटरनेट शब्दावली",
    topics: ["computer-shabdavali"],
  },
  {
    id: "ict",
    name: "Information & Communication Technology",
    nameHi: "ICT (सूचना एवं संचार प्रौद्योगिकी)",
    topics: ["ict"],
  },
  {
    id: "shaikshik-praudyogiki",
    name: "Developments in Educational Technology",
    nameHi: "शैक्षिक प्रौद्योगिकी में विकास",
    topics: ["shaikshik-praudyogiki"],
  },
];
...
const UP_TGT_PGT_SECTIONS = [
  ...
  },
  {
    ...
    // The GS workbooks are Hindi-only, so this subject reads in Hindi
    // throughout, the way the Hindi subject does.
    uiLang: "hi",
    eyebrow: "विषय",
    blurb:
      "आयोग के पाठ्यक्रम की दसों इकाइयाँ उसी क्रम में — समसामयिकी, इतिहास, संविधान, अर्थव्यवस्था, भूगोल, विज्ञान एवं प्रौद्योगिकी, पर्यावरण, कम्प्यूटर, ICT और शैक्षिक प्रौद्योगिकी, हर इकाई अपने अध्यायों में बँटी हुई।",
    facts: [
      "पाठ्यक्रम के अनुसार",
      "हर पेपर में 30 प्रश्न",
      "विगत वर्षों के प्रश्न",
...
/** True for a topic that takes only part of the workbooks it names. */
function isSplit(topic) {
  return Boolean(topic.parts?.length || topic.subjects?.length);
}

/**
 * WHERE fragment selecting one topic's rows, appending its values to `params`.
 *
 * A topic is normally one or more whole workbooks. Where a booklet covers more
 * than one syllabus unit — the GS science booklet runs Physics, Chemistry,
 * Biology and Technology; the ICT one runs computer terminology and ICT
 * applications — the topic also names the chapter headings (`part`) or the
 * finer section headings (`subject_name`) that belong to it, so one file can
 * serve several topics without the Excel ever being re-parsed.
 */
function topicFilter(topic, params) {
  params.push(topic.files);
  let sql = `source_file = ANY($${params.length})`;

  const within = [];
  if (topic.parts?.length) {
    params.push(topic.parts);
    within.push(`part = ANY($${params.length})`);
  }
  if (topic.subjects?.length) {
    params.push(topic.subjects);
    within.push(`subject_name = ANY($${params.length})`);
  }
  if (within.length) sql += ` AND (${within.join(" OR ")})`;
...
async function listFileTopics(section) {
  ...
  // One whole workbook is already counted above. Anything else — a topic
  // spanning two workbooks, which may repeat questions, or one narrowed to part
  // of a workbook — has to be counted in one go.
  const totals = await Promise.all(
    topics.map(async (t) => {
      if (t.files.length === 1 && !isSplit(t)) return counts.get(t.files[0]) || 0;
      const params = [...scope.params];
      const { rows: n } = await query(
        `SELECT COUNT(DISTINCT ${DEDUP})::int AS total
           FROM ctet_questions
          WHERE ${scope.sql} AND ${USABLE} AND ${topicFilter(t, params)}`,
        params
      );
      return n[0].total;
    })
...
export async function getMockQuestions(section, topic, mockNum) {
  ...
  if (section.kind === "topic") {
    topicSql = topicFilter(topic, params);
  } else {
