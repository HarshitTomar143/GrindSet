...
/**
 * General Studies is organised the same way: one Excel workbook per subject of
 * the GS syllabus. Two workbooks are listed but carry nothing usable yet — the
 * environment booklet's extraction stored no question text at all, and the
 * population booklet's source PDF prints no answer key — so both are filtered
 * out until a better pass replaces them, exactly like any other empty topic.
 */
const GS_TOPICS = [
  ...
  // Geography.
  {
    ...
    nameHi: "भारत का भूगोल",
    files: ["Bharat_ka_Bhugol_Questions.xlsx"],
  },
  {
    id: "jansankhya",
    name: "Indian Population",
    nameHi: "भारतीय जनसंख्या",
    files: ["Bhartiya_Jansankhya_Questions.xlsx"],
  },
  {
    id: "paryavaran",
  ...
  },
  {
    ...
    nameHi: "सूचना एवं संचार प्रौद्योगिकी",
    files: ["ICT_Questions_Extracted.xlsx"],
  },
  {
    id: "shaikshik-praudyogiki",
    name: "Educational Technology",
    nameHi: "शैक्षिक प्रौद्योगिकी",
    files: ["Educational_Technology_Questions.xlsx"],
  },

  // Uttar Pradesh. Two passes over the same 205 questions exist; the older one
  // is flagged as a duplicate in build_ctet_data.py and never reaches here.
  {
    id: "up-samanya-gyan",
...
/** The GS syllabus units, in the order the syllabus runs them. */
const GS_UNITS = [
  {
    id: "itihas",
    name: "History",
  ...
  },
  {
    ...
    topics: ["bharat-ka-bhugol", "jansankhya", "paryavaran"],
  },
  {
    id: "rajvyavastha",
    name: "Polity",
    nameHi: "राज्यव्यवस्था",
    topics: ["samvidhan"],
  },
  {
    id: "arthvyavastha",
  ...
  },
  {
    ...
    nameHi: "विज्ञान एवं प्रौद्योगिकी",
    topics: ["samanya-vigyan", "ict", "shaikshik-praudyogiki"],
  },
  {
    id: "uttar-pradesh",
    name: "Uttar Pradesh",
...
const UP_TGT_PGT_SECTIONS = [
  ...
  },
  {
    ...
    eyebrow: "विषय",
    blurb:
      "सामान्य अध्ययन का पूरा पाठ्यक्रम विषयवार — इतिहास, भूगोल एवं पर्यावरण, राज्यव्यवस्था, अर्थव्यवस्था, विज्ञान एवं प्रौद्योगिकी और उत्तर प्रदेश सामान्य ज्ञान, हर इकाई अपने अध्यायों में बँटी हुई।",
    facts: [
      "पाठ्यक्रम के अनुसार",
      "हर पेपर में 30 प्रश्न",
      "विगत वर्षों के प्रश्न",
