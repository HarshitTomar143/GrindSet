...
const UP_TGT_PGT_SECTIONS = [
  {
    ...
    blurb:
      "The Hindi paper laid out the way the syllabus runs it — sahitya ka itihas, gadya sahitya ka itihas, kavyashastra and bhasha vigyan, each split into its own topics.",
