...
/**
 * The Hindi Sahitya bank is organised by source workbook rather than by
 * subject: each Excel sheet is one literature topic. Files not listed here
 * still show up, labelled from their filename, so a new workbook is never
 * silently lost.
 */
const HINDI_SAHITYA_TOPICS = [
...
export const BANKS = [
  ...
  },
  {
    ...
    resultPrefix: "uptgt",
    setupCommand: "npm run setup:ctet",
    chooseTitle: "UP TGT / PGT · Choose a section",
    chooseSub:
      "Practice for the UP TGT and PGT recruitment exams. Hindi Sahitya is organised by literature topic, and each topic is split into mock papers of 30 questions.",
