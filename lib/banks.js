...
/**
 * English, organised the same way: one Excel workbook per topic. The booklets
 * are English-only, so unlike the Hindi topics these carry no Devanagari label.
 */
const ENGLISH_TOPICS = [
  // Literature, one author per booklet.
  ...
  { id: "tennyson", name: "Alfred Lord Tennyson", files: ["Alfred_Lord_Tennyson_MCQs.xlsx"] },
  ...
  // Grammar, in the order the language syllabus runs it: parts of speech and
  // sentence transformation first, then the sentence-level topics.
  {
    id: "tense-parts-of-speech",
    name: "Tense & Parts of Speech",
  ...
  },
  {
    ...
    files: ["Direct_Indirect_Narration_Questions.xlsx"],
  },
  { id: "clause-analysis", name: "Clause Analysis", files: ["Clause_Analysis.xlsx"] },
  { id: "preposition", name: "Prepositions", files: ["Preposition_Questions.xlsx"] },
  ...
  { id: "common-error", name: "Common Errors", files: ["Common_Error_Questions.xlsx"] },
  {
    id: "find-correct-sentence",
    name: "Find the Correct Sentence",
  ...
  { id: "idioms", name: "Idioms & Phrases", files: ["Idioms_Questions.xlsx"] },
  {
  ...
  { id: "comprehension", name: "Comprehension", files: ["Comprehension_Questions.xlsx"] },
];

/** The syllabus units the English topics sit under, in syllabus order. */
const ENGLISH_UNITS = [
  {
    id: "british-poetry-drama",
    name: "British Poetry & Drama",
    topics: ["shakespeare", "milton", "wordsworth", "keats", "shelley", "tennyson", "arnold"],
  },
  {
    id: "british-prose-fiction",
    name: "British Prose & Fiction",
    topics: ["lamb", "dickens", "hardy"],
  },
  {
    id: "american-literature",
    name: "American Literature",
    topics: ["whitman", "frost", "hemingway", "faulkner"],
  },
  {
    id: "indian-english-literature",
    name: "Indian English Literature",
    topics: ["mulk-raj-anand", "kamala-das", "nissim-ezekiel"],
  },
  {
    id: "literary-forms-terms",
    name: "Literary Forms & Terms",
    topics: ["literary-forms"],
  },
  {
    id: "grammar",
  ...
  },
  {
    ...
    topics: ["synonyms", "antonyms", "idioms", "one-word-substitution", "spelling"],
  },
  {
    id: "comprehension",
    name: "Comprehension",
...
const UP_TGT_PGT_SECTIONS = [
  ...
  },
  {
    ...
    eyebrow: "Subject · विषय",
    blurb:
      "The English paper laid out the way the syllabus runs it — the British, American and Indian English writers, literary forms and terms, grammar, vocabulary and comprehension, each split into its own topics.",
    facts: ["Syllabus-wise", "30 per paper", "PYQ based", "Explanations included"],
    kind: "topic",
